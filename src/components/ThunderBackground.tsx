...
const ThunderBackground = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-revenant-purple-dark/80 to-revenant-darker"></div>
      
      {/* Overlay gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-revenant-purple-dark/30"></div>
